...
model_name = 'eUniRep_gfp_13687'
UNIREP_BATCH_SIZE = 1

csv_path_sn = '/share/jake/Low_N_data/csv/sn_data_set.csv'#'/share/jake/Low_N_data/csv/sn_data_set.csv'
csv_path_fp = '/share/jake/Low_N_data/csv/fp_data_set.csv'
csv_path_sk = '/share/jake/Low_N_data/csv/sk_data_set.csv'#'/share/jake/Low_N_data/csv/sk_data_set.csv'
csv_test_32509 = '/share/jake/UniRep泛化验证数据/随机生成序列/test_32509.csv'
UNIREP_BATCH_SIZE = 1

data_set = "fp"
output_path = f"/share/jake/Low_N_data/ebd/{model_name}/GFP_{data_set}"
