...
def load_pca(PCA_19_EBD_PATH, seq):
    ...
    return np.array(seq_pca).swapaxes(0,1)
...
def encode_aa_seq_as_one_hot_pca_vector(
        aa_seq, PCA_19_EBD_PATH, alphabet=constants.AA_ALPHABET_STANDARD_ORDER, 
    ...
    """
    seq_pca = load_pca(PCA_19_EBD_PATH, aa_seq)
    ...
    ohe_matrix = np.concatenate([ohe_matrix, seq_pca], axis=0)
    # print("ohe_matrix shape: ", ohe_matrix.shape)
    # print("ohe_matrix shape: ", ohe_matrix.reshape(-1, order='F').shape)
